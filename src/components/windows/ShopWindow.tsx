...
const ShopWindow = () => {
  ...
  return (
    <div className="h-full overflow-auto py-6 px-8 bg-white text-black">
      {/* Header with Mac-like design */}
      <header className="mb-8 flex justify-between items-center">
        <div>
          <h2 className="text-2xl font-medium text-gray-900">PIXEL CHIC Shop</h2>
          <p className="text-gray-500 text-sm mt-1">Discover our web3 fashion pieces</p>
        </div>
        ...
        {categories.map(category => (
          <Button 
            ...
            className={selectedCategory === category 
              ...
              : "rounded-full border-gray-300 text-gray-700 hover:bg-gray-100"}

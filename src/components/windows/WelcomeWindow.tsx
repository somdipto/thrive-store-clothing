  ...
  return <div className="h-full flex flex-col items-center justify-center bg-white">
      <div className="text-center max-w-md">
        ...
        <div className="my-8 flex justify-center">
          <img alt="Brand Featured" src="/lovable-uploads/3296e2f2-6222-4867-87f0-6ff31a701ac0.png" className="w-54 h-54 rounded-lg shadow-md object-cover" />
        </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <Button variant="default" className="bg-black hover:bg-gray-800 text-white font-medium py-2 px-8 rounded-md">
            SHOP NOW
          </Button>
          <Button variant="outline" className="border border-black text-black hover:bg-gray-200 font-medium py-2 px-8 rounded-md">CONTACT
        </Button>
        </div>
      </div>
    </div>;
